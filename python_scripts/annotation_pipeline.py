...
#inout: line separated file of TS559 positions
index_path = './data/m5C_positions.lsv'
outfile_name = 'annotation_ready.tsv'

#associated files to help with annotations
TS559_genome_path = './data/TS559_reference_genome.fasta'
KOD1_genome_path = './data/KOD1_reference_genome.fasta'
annotation_path = './data/TS559_annotations.gtf'
UTR5_path = './data/UTR5_TS559.gtf'
UTR3_path = './data/UTR3_TS559.gtf'
TSS_TS559_positions_path ='./data/TSSs_TS559.tsv'
RNA_folds_path = "./data/Tko_allgenes_85C_fold.tsv"
